...
CREATE TABLE LabActivity (
    ...
    Lab funds when allocated to Activity then it is subtracted from Lab funds,  
    and when purchase is made against the activity, 
    then it is subtracted from activity funds and available funds will be updated.
    */  
...
CREATE TABLE RequestItem (
    ...
    RequestId INT,
    ItemId INT,
    IsUnknown BOOLEAN, /* If the item is not listed in item list, then it will be unknown*/
